 ...
 * @author David Kolb
 */
public class HistogrammCreatorNodePlugin extends Plugin {
    // The shared instance.
    private static HistogrammCreatorNodePlugin plugin;

    /**
     * The constructor.
     */
    public HistogrammCreatorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static HistogrammCreatorNodePlugin getDefault() {
        return plugin;
    }
